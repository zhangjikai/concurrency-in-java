...
## Wait and Notify
在 Java 中可以用 wait/notify 来实现进程间的通信，一个经典的例子就是生产者和消费者模型。我们将从下面几个方面来描述一下这种机制
* 相关的函数
* 为什么定义在 Object 中
* 为什么在同步块中
* 生产者消费者问题
...
### 相关函数
与 wait/notify 相关的函数有下面5个，这 5 个函数都是 `Object` 类中的方法，所以线程 wait 或者 notify 时都会关联一个相关的对象。
```java
